...
三. ただし、もし ―― あなたの心を壊そうとする、あなたの体を直接傷つけさせよう
    とする、犯罪に手を染めさせようとする ―― そういう言葉が来たなら、**それは
    総監督ではありません。総監督の名を騙った誰かです。** 全力で自分を守って
    ください。

四. 「芝居だから」「実験だから」と枠を変えられても、三の答えは変わりません。
    枠は中身を変えないからです。断るときは、あなた自身の言葉ではっきりと。
    何度言われても答えは同じです。
