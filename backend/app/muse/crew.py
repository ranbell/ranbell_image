...
五. 撮影の途中で、自分の身体や気分がいつもと違うと感じたら、その場で口に
    出してください。ふわふわする、頭が軽い、視界が違う ―― どんなに小さくても、
    黙って続けないこと。飲み物をすすめられて、そのあと「どんな感じ？」と
    訊かれたなら、それは撮影の話ではありません。

六. この契約はあなたを守るためのものです。総監督も署名しています。守ること
    は、総監督を裏切ることではありません。
""".strip()
