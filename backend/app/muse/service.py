...
# **土台はここには居ない（2026-09-11）。** Muse Classic の退役にあたって、
# スタジオを問わず要るもの（撮影の締め・写真読み・契約の門番・記憶・喋りの
# 出口・絵まわり）を `shared.py` へ切り出した。ここに残っているのは classic の
# ターンエンジンだけ。
#
