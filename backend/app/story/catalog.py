    ...
    *,
    ...
    return {
        ...
        "endpoints": {
            ...
            "patch_inputs": "PATCH /api/weave/sessions/{session_id}/inputs",
            ...
            "unlock_character": "POST /api/weave/sessions/{session_id}/character/unlock",
            "board": "POST /api/weave/sessions/{session_id}/character/board",
            "accept_board": "POST /api/weave/sessions/{session_id}/character/accept-board",
            ...
            "story_rollback": "POST /api/weave/sessions/{session_id}/story/rollback",
            "story_narrative": "PATCH /api/weave/sessions/{session_id}/story/narrative",
            ...
            "sample_rate": "POST /api/weave/sessions/{session_id}/sample/rate",
            "override_framing": "POST /api/weave/sessions/{session_id}/sample/override-framing",
            "reeval_framing": "POST /api/weave/sessions/{session_id}/sample/reeval-framing",
            "vlm_assist": "POST /api/weave/sessions/{session_id}/sample/vlm-assist",
            "score": "POST /api/weave/sessions/{session_id}/score",
            "stream": "GET /api/weave/sessions/{session_id}/stream",
            "render_final": "POST /api/weave/sessions/{session_id}/render_final",
            "seal": "POST /api/weave/sessions/{session_id}/seal",
            "export": "GET /api/weave/sessions/{session_id}/export",
